...
from utils import get_random_tmdb_backdrop  # get the function from utils.py
...
async def start(client, message):
    ...
    image_url = get_random_tmdb_backdrop()  # Get random backdrop image
    ...
    await message.reply_photo(
        photo=image_url,  # Use random image URL
