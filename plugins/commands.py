...
async def start(client, message):
    ...
    if temp.SHORT.get(user) == None:  
        ...
        return  # পরবর্তী কোড স্কিপ হবে, এই অংশটি চলে যাবে
    else:
        chat_id = temp.SHORT.get(user)
...
"""
    ...
    await callback_query.answer(f"Request {action.title()}ed!")
